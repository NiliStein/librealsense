...
int main(int argc, char * argv[]) try
{
	...
	ux_window window("RealtimeBreathing"); // Create windows app window
	...
	//ImGui_ImplGlfw_Init(window, false);      // ImGui library intializition
	...
	//while (window) // Application still alive?
	//{
	//	// Render the UI:
